...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output_glb')
...
def extract_glb(
    ...
    # Save to both temporary and output directories
    glb_path = os.path.join(user_dir, 'sample.glb')
    output_path = os.path.join(OUTPUT_DIR, f'sample_{int(time.time())}.glb')
    
    glb.export(glb_path)
    glb.export(output_path)  # Save a copy to the output directory
