...
from .config import (
    TRELLIS_MODEL, SPCONV_ALGO,
    DEFAULT_SEED, DEFAULT_SPARSE_STEPS, DEFAULT_SLAT_STEPS, DEFAULT_CFG_STRENGTH,
    OUTPUT_DIR, LOG_LEVEL, LOG_FORMAT
)
...
class AssetGenerator:
    ...
    def generate_assets(self, scene_name, object_name, prompt, output_dir, seed=DEFAULT_SEED, 
                       sparse_steps=DEFAULT_SPARSE_STEPS, slat_steps=DEFAULT_SLAT_STEPS):
    ...
    def process_scene(self, scene_data, output_dir, progress, seed=DEFAULT_SEED, 
                     sparse_steps=DEFAULT_SPARSE_STEPS, slat_steps=DEFAULT_SLAT_STEPS):
    ...
    def generate_all_assets(self, prompts_file, output_dir, delete_existing=False, seed=DEFAULT_SEED, 
                           sparse_steps=DEFAULT_SPARSE_STEPS, slat_steps=DEFAULT_SLAT_STEPS, progress=None):
        ...
        try:
            ...
            for i, scene in enumerate(data['scenes'], 1):
                ...
                results = self.process_scene(scene, output_dir, progress, seed, sparse_steps, slat_steps)
